 ...
 */
final class Version20231008113027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` ADD user_id INT NOT NULL, ADD comment_id INT NOT NULL, ADD dislike TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` DROP user_id, DROP comment_id, DROP dislike');
    }
}
